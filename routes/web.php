...
Route::get('users/{iconName?}', 'UserController@listUsers')->name('users.list');
Route::get('departments', 'DepartmentController@listDepartments')->name('departments.list');
Route::get('departments/users/{department_id}', 'UserController@listUsers')->name('department.users.list');
//US 1.2
