<div id="myCarousel" class="carousel slide full-width-div" data-ride="carousel">
    <!-- Indicators -->
    ...
    <div class="carousel-inner">
        ...
        <div class="item orange">
            ...
            <span class="text-size-slide">WE ARE<span class="text-black">EVENT!</span></span></h2>
        </div>
    </div>
