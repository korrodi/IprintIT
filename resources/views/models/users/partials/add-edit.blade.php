...
<div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
    ...
    <div class="col-md-6">
        <input id="name" type="text" class="form-control" value="{{ $user->name }}{{ old('name') }}" required autofocus>
...
<div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
    ...
    <div class="col-md-6">
        <input type="text" class="form-control" placeholder="jonh.doe@urbanfarmers.com"  id="email" value="{{ $user->email }}{{ old('email') }}" required autofocus>
...
<div class="form-group{{ $errors->has('presentation') ? ' has-error' : '' }}">
    ...
    <div class="col-md-6">
        ...
        <textarea id='presentation' rows="4" cols="55">{{ old('presentation') ? old('presentation') : $user->presentation }}</textarea>
...
<div class="form-group{{ $errors->has('profile_url') ? ' has-error' : '' }}">
    ...
    <div class="col-md-6">
        ...
        <input type="url" class="form-control" id="profile_url" value="{{ $user->profile_url }}{{ old('profile_url') }}">
