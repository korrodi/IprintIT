...
class LandingController extends Controller
{
    public function index()
    {
        ...
        $cores = DB::table('requests')->where('colored', '1' and 'status', '1')->count();
        $pb = DB::table('requests')->where('colored', '0' and 'status', '1')->count();
        ...
        return view('pages.landing', compact('pageTitle', 'statisticData', 'users', 'departments'));
    }
}
